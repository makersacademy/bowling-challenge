...
class bowlingGame {
  ...
  bonusCalc() {
    let bonus = 0;
      ...
      const frameTotal = this.rolls[this.frameIndex - 1][this.rollIndex] + this.rolls[this.frameIndex - 1][this.rollIndex + 1];
  ...
  spareBonus() {
    return this.rolls[this.frameIndex - 1][this.rollIndex + 2];
  };
