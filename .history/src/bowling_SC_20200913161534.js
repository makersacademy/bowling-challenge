...
class bowlingGame {
  ...
  isStrike() {
    return this.rolls[this.frameIndex - 1][this.rollIndex] === 10;
  };

  strikeBonus() {
    return this.rolls[this.frameIndex - 1][this.rollIndex + 1] + this.rolls[this.frameIndex - 1][this.rollIndex + 1];
  };
