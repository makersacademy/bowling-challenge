describe('Frame', function() {
  ...
  describe('addRound', function() {
    ...
    it('throws an error if more than two rounds are added to a frame', function() {
      frame.addRound(round);
      frame.addRound(round);
  ...
  describe('isStartingWithStrike', function() {
    it('returns true if first round was a strike', function() {
      frame.addRound(new Round(10));
      frame.addRound(new Round(0));

      expect(frame.isStartingWithStrike()).toEqual(true);
    });
  });

  describe('isFrameComplete', function() {
    it('returns true if frame has been completed', function() {
      frame.addRound(new Round(8));
      frame.addRound(new Round(1));

      expect(frame.isFrameComplete()).toEqual(true);
    });

    it('returns false if frame has not been completed', function() {
      frame.addRound(new Round(8));
