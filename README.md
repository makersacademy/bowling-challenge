...
\margl1440\margr1440\vieww20160\viewh15540\viewkind0
...
- in the console, create a new game using ```var game = new Game(\'91yourNameHere\'92);```\
- play the game by calling ```game.currentFrame.bowl(yourScore)```, passing it the number of pins you bowled (10 max). \
- call ```game.nextFrame();``` to move on to the next frame (helpful error messages should let you know if your current frame hasn\'92t been completed)\
