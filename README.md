...
* Used Javascript for the business logic, HTML, CSS, Javascript and jQuery for the front end.
...
* To run tests open the SpecRunner.html in a browser

![Bowling Screenshot](/images/Screenshot.png)
