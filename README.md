...
```
As a user
So that I score a frame of 10-pin bowling
...
I would like the game to keep score over 10 frames
```

```
As a user
So that I can keep an effective score
I would like the game to account for spare and strike score multipliers
```
