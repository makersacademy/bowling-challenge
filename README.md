...
100% test coverage across all files as indicated by the LCOV and Jest coverage reports below. Full coverage reports generated by LCOV are included in the coverage folder.
