...
This app sums the scores of a bowling game for one player (in JavaScript).
...
```
git clone https://github.com/cbp10/bowling-challenge
...
Open SpecRunner.html to see tests run in Jasmine