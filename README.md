...
Bowling Challenge
=================
[![Build Status](https://travis-ci.org/arnoldmanzano/bowling-challenge.svg?branch=master)](https://travis-ci.org/arnoldmanzano/bowling-challenge)

Bowling Scoring web app that records individual rolls and calculates running score total.

#### Instructions:
```sh
$ git clone <repo>
$ open SpecRunner.html    # to run the tests
$ open index.html         # to start the web app
```

Screenshot:
![Imgur](http://i.imgur.com/MidxOVj.jpg?1)
