...
describe('Features', function () {
  ...
  describe('record regular rolls', function () {
    ...
    it('allows the player to record the number of pins hit for each roll', function () {
      ...
      expect(game._frames[0].getRolls()).toEqual([5, 4])
    })
  })
  ...
  // As a player, so I don't have to remember my score, I want to see the history of my scores for each frame.
  describe('frame score history', function() {
    it('allows the player to see the score history of their previous frames', function () {
      game.enterDroppedPins(5)
      game.enterDroppedPins(5)
      game.enterDroppedPins(4)
      game.enterDroppedPins(2)
      expect(game._frames[0]._calculateRolls()).toEqual(10)
      expect(game._frames[1]._calculateRolls()).toEqual(6)
    })
    it('allows the player to see the score history including bonus rolls for each frame', function() {
      game.enterDroppedPins(5)
      game.enterDroppedPins(5)
      game.enterDroppedPins(4)
      game.enterDroppedPins(2)
      expect(game._frames[0].calculateScore()).toEqual(14)
    })
  })
  ...
  // As a player, to be rewarded for my skill, I want to be credited extra scores when I bowl a spare
