...
class Frame10 extends Frame {
  addRoll(roll) {
    ...
    // If the first roll is a strike and the second isn't
    if (this.numRolls === 2 && this.rolls[0] === 10 &&
      this.rolls[1] !== 10 && this.rolls[1] + roll > 10) {
  ...
  format() {
    ...
    const outputFunctions = {
      ...
      3: () => {
        ...
        } else if (this.rolls[1] !== 10 && this.rolls[1] + this.rolls[2] === 10) {
          return `${symbols[0]},${symbols[1]},/`;
        } else {
