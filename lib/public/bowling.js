...
Game.prototype.organiseFrameTotals = function () {
  ...
  for (var i = this.frameScore.length-1; i >= 0; i--) {
    if (this.isStrike(this.frameScore[i])) {
      ...
      else if (i == this.frameScore.length-2 && (this.isStrike(this.frameScore[this.frameScore.length-1]) || this.isSpare(this.frameScore[this.frameScore.length-1])))
        { this.frameTotals.push('?'); }
      else {
...
Game.prototype.isGameFinished = function () {
  return this.frameTotals.length == 10
};
