describe("Game", function() {
  ...
  xit ("should finish after 10 frames", function(){
    for (var i = 0; i <= 21; i++) {
      game.pinsDown(4)
    }
  ...
  xit ("should give a score of 15 to a spare that the next ball is a 5", function(){
      game.pinsDown(5);
      game.pinsDown(5);
      game.pinsDown(5);
      expect(game.frameAdder(1)).toEqual(15);
  });

  xit ("should give a score of 15 to a strike that the next two balls is a 3 and a 2", function(){
      game.pinsDown(10);
      game.pinsDown(3);
      game.pinsDown(2);
      expect(game.frameAdder(1)).toEqual(15);
  ...
  xit ('should return true to the strikeTest when a strike is bowled', function(){
    game.pinsDown(10);
    expect(game.strikeTest(1)).toEqual(true);
  });
