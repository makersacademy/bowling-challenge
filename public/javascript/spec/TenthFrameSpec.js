describe('TenthFrame', function() {
  ...
  it('doesn\'t allow less than 0 pins to be felled', function() {
    ...
    }).toThrow(new Error('You cannot fell fewer pins than 0'));
  });

  it('doesn\'t allow less more than 10 pins to be felled', function() {
    expect(function() {
      tenthFrame.addRoll(11);
    }).toThrow(new Error('You cannot fell more pins than 10'));
  });
  ...
  it('doesn\'t allow more than 10 pins to be felled in a frame unless there is a strike or spare', function() {
    ...
    }).toThrow(new Error('You can only fell 10 pins total in the tenth frame unless you have scored a spare or strike'));
  });
