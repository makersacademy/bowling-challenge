class Scorecard {
  ...
  #is_going_to_make_frame_score_impossible (score) {
    ...
    } else if (this.#is_an_incomplete_frame()) {
  ...
  #is_making_the_code_DRY (score, previousRollIndex) {
    if (this.scores[this.scores.length - 1][previousRollIndex] + score > 10 &&
       this.scores[this.scores.length - 1][previousRollIndex] !== 10) {
      return true
    } else {
      return false
    };
