describe('Game', function() {
  ...
  it('It can add pins to the current frame,', function() {
    aGame.sendToFrame(3)
    aGame.sendToFrame(4)
  ...
  it('add a frame to the played frames array', function() {
    aGame.sendToFrame(3)
    aGame.sendToFrame(4)
    aGame.sendToFrame(5)
  ...
  it('add a frame score to the general score', function() {
    aGame.sendToFrame(3)
    aGame.sendToFrame(4)
    aGame.sendToFrame(5)
    expect(aGame.playedFrames.length).toEqual(1)
  ...
  it('It only accepts integers between 0 and GAME_PINS (10) to send to a roll via a frame,', function() {
