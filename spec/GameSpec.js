describe('Game', function() {
  ...
  it('has 10 gameFrames', function() {
    expect(game.TOTAL_FRAMES).toEqual(10);
  });

  it('starts with empty gameFrames list', function() {
    expect(game.gameFrames.length).toEqual(0);
  });
  ...
  describe('gameplay', function() {
    ...
    it('when frame has 0 pins, start next frame', function() {
      game.knockDown(10);
      game.knockDown(1);
      expect(game.gameFrames.length).toEqual(2);
    });
    ...
    it('when player knocks 1 pin and then 2 pins, the game score is 3', function() {
      game.knockDown(1);
      game.knockDown(2);
