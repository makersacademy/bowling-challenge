describe("game", function() {
  ...
  beforeEach(function() {
    ...
    describe('first frame logic', function() {

      it('have no pins down when the game starts', function() {
      ...
      it ('does not move to the second frame if the first try is not a strike', function(){
