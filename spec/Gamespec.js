describe("Game", function () {
  ...
  describe ("should calculate the correct accumulate score", function () {
    ...
    it("calculate correct accum score when no bonus", function () {
      for (i = 1; i <= 20; i++) {
        game.knockDown(2);
      }
      for (i = 1; i < 10; i++) {
    ...
    it("calculate correct accum score when is Spare", function () {
      for (i = 1; i <= 21; i++) {
        game.knockDown(5);
      }
      for (i = 1; i < 10; i++) {
    ...
    it("calculate correct accum score when is Strike", function () {
      for (i = 1; i <= 12; i++) {
        game.knockDown(10);
      }
      for (i = 1; i < 10; i++) {
