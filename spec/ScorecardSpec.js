...
describe('Scorecard:', function() {
  ...
  describe('new:', function() {
    it('_scores is empty', function() {
      expect(scorecard._scores).toEqual([]);
    });

    it('_frames is empty', function() {
      expect(scorecard._frames).toEqual([]);
    });
  });
