...
describe('TenPin', function(){
 tenpin = new TenPin();
  ...
  it("should record one frame", function(){
    tenpin.throw(0);
    tenpin.throw(8);
...
describe ('count', function(){
  it ("should count the correct score without bonus", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[0,5],[6,3],[4,4],[8,1],[3,6],[2,1],[4,3],[2,2],[1,1],[8,0]];
    tenpin.count();
  ...
  it ("should count the correct score with Spares", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[5,5],[6,3],[4,4],[8,1],[3,6],[2,1],[4,3],[2,2],[1,1],[8,1]];
    tenpin.count();
  ...
  it ("should count the correct score with a 0 10 Spare", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[0,10],[6,3],[4,4],[8,1],[3,6],[2,1],[4,3],[2,2],[1,1],[8,1]];
    tenpin.count();
    expect(tenpin.score).toBe(76);
  ...
  it ("should count the correct score with a Strike", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[0,10],[10,0],[4,4],[4,1],[3,6],[2,1],[4,3],[2,2],[1,1],[8,0]];
    tenpin.count();
  ...
  it ("should count the correct score with many Strikes", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[0,10],[10,0],[10,0],[4,4],[1,3],[6,2],[1,4],[10,0],[10,0],[8,1]];
    tenpin.count();
  ...
  it ("should count the correct score with many Spares and Strikes", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[0,10],[5,5],[10,0],[4,6],[1,3],[6,2],[1,4],[10,0],[10,0],[8,1]];
    tenpin.count();
  ...
  it ("should count the correct score with many Spares and Strikes", function(){
    tenpin.reset();
    tenpin.scoreHistory =
    [[1,4],[4,5],[6,4],[5,5],[10,0],[0,1],[7,3],[6,4],[10,0],[2,8],[6,0]];
    tenpin.count();
