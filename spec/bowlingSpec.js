describe('Bowling', function() {
  ...
  describe("#Game()", function() {
    ...
    describe("#Frame()", function() {
      ...
      it("small sample game 2", function() {
        for (var i = 0; i < 3; i++) {
          game.bowlScore(10)
        }
        game.bowlScore(0)
      ...
      it("PERFECT game score to equal 300", function() {
        ...
        game.bowlScore(0)
        expect(game.scoreSheet[0].rollingScore).toEqual(30)
        expect(game.scoreSheet[1].rollingScore).toEqual(60)
        expect(game.scoreSheet[2].rollingScore).toEqual(90)
        expect(game.scoreSheet[3].rollingScore).toEqual(120)
        expect(game.scoreSheet[4].rollingScore).toEqual(150)
        expect(game.scoreSheet[5].rollingScore).toEqual(180)
        expect(game.scoreSheet[6].rollingScore).toEqual(210)
        expect(game.scoreSheet[7].rollingScore).toEqual(240)
        expect(game.scoreSheet[8].rollingScore).toEqual(270)
        expect(game.scoreSheet[9].rollingScore).toEqual(300)


      });

      it("small sample game 3", function() {
        for (var i = 0; i < 9; i++) {
          game.bowlScore(10)
        }
        expect(game.scoreSheet[8].rollingScore).toEqual(240)

      });

      it("sample game 4", function() {
        for (var i = 0; i < 16; i++) {
          game.bowlScore(0)
        }
        for (var i = 0; i < 4; i++) {
        ...
        expect(game.scoreSheet[8].rollingScore).toEqual(30)
        expect(game.scoreSheet[9].rollingScore).toEqual(60)
