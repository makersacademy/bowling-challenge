describe('Bowling', function() {
  ...
  it('can have a strike', function() {
    bowling.pinsHit(10);
    expect(bowling.bonusStrike).toEqual(10);
  });

    it('can have a spare', function() {
    bowling.pinsHit(5);
    bowling.pinsHit(5);
    expect(bowling.bonusSpare).toEqual(10);
  });
  ...
  it('should add the score for a strike to the next frame score', function() {
    ...
    bowling.pinsHit(5);
    bowling.pinsHit(1);
    expect(bowling.currentScore).toEqual(16);
  });

  it('should add the score for a spare to the next frame score', function() {
    bowling.pinsHit(2);
    bowling.pinsHit(4);
    bowling.pinsHit(2);
    bowling.pinsHit(4);
