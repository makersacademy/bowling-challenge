describe("Bowling Score", () => {
  ...
  it("a player can only knock over a maximum of 10 pins", () => {
    expect(() => {
      bowlingScore([[11]])
    }).toThrow("invalid number of pins supplied (MAX is ten)");
  });

  it("a spare adds the pins from the next roll as a bonus", () => {
    expect(bowlingScore([[3,7], [4,0]])).toEqual(18);
  });

  it("a strike adds the pins from the next two rolls as a bonus", () => {
