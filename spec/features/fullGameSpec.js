...
describe('Playing a full game', function () {
  ...
  describe('player bowls a mixed game', function () {
    it('has a score of 118', function () {
      this.rollMany(game, 2, 10);
      this.rollMany(game, 2, 5);
      this.rollMany(game, 2, 4);
      this.rollMany(game, 4, 5);
      this.rollMany(game, 4, 0);
      game.roll(10);
      this.rollMany(game, 2, 4);
