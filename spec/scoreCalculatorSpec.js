...
describe('Score Calculator', function() {
  ...
  it('calculates a total score for a varied game', function() {
  ...
  it('calcualtes the total score of a perfect game', function() {
  ...
  it('calculates the total score of a game with a range of spares', function() {
  ...
  it('calculates the total score of a game a mix of spares and strikes', function() {
  ...
  it('calculates the total score of gutter game', function() {
