...
describe("Scorecard", function() {
    var score;
    var testScorecard = Array(10).fill(0).map( x => Array(3).fill(0));
    ...
    it("can be updated with a score", function() {
      console.log(this.scores);
        ...
        expect(score.scores[0][0]).toEqual(10);
        expect(score.scores[0][1]).toEqual(0);
        expect(score.scores[1][0]).toEqual(3);
        expect(score.scores[1][1]).toEqual(6);
        expect(score.scores[2][0]).toEqual(5);
        expect(score.scores[2][1]).toEqual(5);
        expect(score.scores[8][0]).toEqual(7);
        expect(score.scores[8][1]).toEqual(1);
        expect(score.scores[9][0]).toEqual(10);
        expect(score.scores[9][1]).toEqual(10);
        expect(score.scores[9][2]).toEqual(5);
