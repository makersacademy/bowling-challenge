...
describe('GutterBowlingGame', function() {
  ...
  it('info gets added to scorecard after each roll', function () {
    rolls(0,1)
    expect(bowlingGame.scoreCard.length).toEqual(1)
    expect(bowlingGame.scoreCard[0].score).toEqual(0)
    expect(bowlingGame.scoreCard[0].frame).toEqual(1)
