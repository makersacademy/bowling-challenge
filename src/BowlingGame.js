...
BowlingGame.prototype.setFrame = function(frameNo, bowl1, bowl2, bowl3 = 0) {
...
BowlingGame.prototype.calcScore = function() {
    for (let i = 0; i < Object.keys(this.scoreCard).length; i++ ) {
        this.score += this.scoreCard[i + 1].bowl1 + this.scoreCard[i + 1].bowl2 + this.scoreCard[i + 1].bowl3;
    }
};