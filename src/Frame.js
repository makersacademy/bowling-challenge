...
Frame.prototype.total = function(next_frame, next_but_next_frame) {
  return this._frameScore() + this._bonusScore(next_frame, next_but_next_frame)
}
...
Frame.prototype._bonusScore = function(next_frame, next_but_next_frame) {
  if (undefined === next_frame) return 0
  if (this._isStrike()) return next_frame._strikeBonus(next_but_next_frame)
