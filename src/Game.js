...
Game.prototype._fillInNullScores = function (frameNumber) {
  ...
  if (frameNumber >= 1 && this._isPreviousFrameSpare(frameNumber)) {
    ...
    this._scores[frameNumber+1] = this._scores[frameNumber] + this._frames[frameNumber].getFrameScore();
  }
  ...
  if (!frame.isStrike() && this._isPreviousFrameStrike(frameNumber)) {
    var delta = this._scores[frameNumber-1] + 10 + this._frames[frameNumber].getFrameScore();
