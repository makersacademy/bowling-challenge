...
Game.prototype.assignFrames = function(){
	for(var i=0; i<10; i++){this._frames.push(new Frame());}
};
...
Game.prototype.bonusPlay = function(knockedPins){
	this._frames[this.frameIndex()]._bonusRollPins += knockedPins
...
Game.prototype.hasBonusPlay = function(){
	if(this.frameIndex()== 9 && (this._strike == true || this._spare == true)){
		return true;}
}
