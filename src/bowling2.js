...
Ball.prototype.bowl = function(pins) {
  ...
  else if ( this.go === 2 && this.remainingPins === 0 && this.frame === 10 ) {this.special = "strike"; }
...
Ball.prototype.setup = function(lastBall) {
  if (lastBall.frame === 10 && lastBall.go === 1 ) {
    ...
    if (lastBall.remainingPins) { this.remainingPins = lastBall.remainingPins }
    else { this.remainingPins = 10 };
  }
