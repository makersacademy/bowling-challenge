...
Display.prototype.currentDisplayElements = function () {
...
Display.prototype.toDisplay = function (pinsKnockedDown) {
  ...
  if (itsTheTenthFrame && theyKnockedTenPinsDown) {
    this.recordsATenthFrameStrike()
  } else if (itsTheFirstThrowOfAFrame && theyKnockedTenPinsDown) {
    this.recordsAStrike()
  } else if (itsTheSecondThrowOfAFrame && (theyKnockedTenPinsDown || theTotalForTheFrameIsTen)) {
    this.recordsASpare()
  } else if (theyKnockedNoPinsDown) {
    this.recordsAMiss()
  } else {
