...
describe('gutter game, 10 frames with 0 points', () => {
  it('adds all frames with a score of 0, returns a total score of 0', () => {
...
describe('a game with only spares scored', () => {
  it('returns total score of 150, 100 from frames and 50 from the bonus roll', () => {
...
describe('a game with spares and strikes and a spare is scored in the 10th frame', () => {
  it('returns a total score of 115', () => {
    const scoreboard = new Scoreboard
    let frame = new Frame(10)
    scoreboard.add_frame(frame)
    frame.strike()
